  ...
  <div class="offcanvas-body small pt-1" style="display: flex;align-items: center;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mb-1"><a target="_blank" href="https://pinterest.com/pin/create/button/?url=<?= base_url().'recipes/detailsid='.$recipe_info['ID'] ?>&media=<?= base_url($recipe_info['IMAGE']) ?>" style="width: 100%;background-color: #bd081c; color: #fff;text-align: center;padding: 10px 10px;font-size: 1.5em;border-radius: 6px;"><i class="bi-pinterest"></i>&nbsp;PINTEREST</a></div>
