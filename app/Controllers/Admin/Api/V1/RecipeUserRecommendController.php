...
class RecipeUserRecommendController extends ResourceController
{
    protected $modelName = 'App\Models\Admin\Recipes\RecipeUserRecommendLinkModel';
    ...
    public function delete($id = null)
    {
        ...
        try {
            ...
            $db->transCommit();
            return $this->respond(['message' => 'Unset successfully'], 200);
        } catch (DatabaseException $e) {
            $db->transRollback();
            return $this->failServerError($e->getMessage());
        } catch (Exception $e) {
