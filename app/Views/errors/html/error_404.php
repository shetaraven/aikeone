...
<body>
    ...
    <div class="main"> 
        ...
        <div class="content-section">
            <h2>Oops! Looks like this recipe got lost in the kitchen.</h2>
            <p>We couldn’t find the page you were looking for, but don’t worry — we have plenty of other delicious recipes to explore. You will be redirected in <span id="counter" style="color: #cb6e35;font-size: 20px;"></span> or you can Click <a href="/">here</a> to get back on track!</p>
        </div>  
    </div>
